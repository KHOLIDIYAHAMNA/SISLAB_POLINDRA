                ...
                <div>
                    <div class="d-flex justify-content-between align-items-center">
                        <div class="mb-2 mb-lg-0">
                            <h3 class="mb-0  text-white"><i data-feather="user" class="nav-icon icon-xs me2"></i>Data Mahasiswa
                            </h3>
                        </div>
                        <div class="mb-2 mb-lg-0">
                            <a href="#">
                                            ...
                                            <td class=" align-middle text-dark">
                                                <div class="avatar-group">
                                                    <span class="avatar-sm avatar-primary">
                                                        ...
                                                        <a class="btn btn-danger btn-ivcon rounded-circle indicator-primary text-dark"
                                                            href="#" role="button">
